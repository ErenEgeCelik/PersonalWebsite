...
status: "Case study"
tags: ["prediction-markets", "polymarket", "market-microstructure", "latency", "risk"]
summary: "Three successive edges in Polymarket's daily maximum-temperature markets: observation latency from a state meteorological feed, the mass redistribution of a dying bucket implemented as a Markov decision problem, and the forecast itself. Two of the three are gone — and I can say precisely why each died. The account grew from roughly $30 to roughly $1,200."
---
